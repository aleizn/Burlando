...
enlace = official[0][0] == String(contact[0]) ? 'https://www.instagram.com/ale.izn_20/' : official[1][0] == String(contact[0]) ? 'https://www.instagram.com/ale.izn_20/' : official[2][0] == String(contact[0]) ? 'https://www.instagram.com/ale.izn_20/' : official[3][0] == String(contact[0]) ? 'https://www.instagram.com/ale.izn_20/' : md 
   
lista.push([number, ofc, nombre, description, official[3][0] == String(contact[0]) ? null : correo, lugar, enlace, bio, official[1][0] == String(contact[0]) ? 'https://www.instagram.com/ale.izn_20/' : null]) }  
